...
set -eu # set -f will not work since this will disable filename expansion (globbing) upon seeing *, ?, etc.
...
#adapted from https://gist.github.com/c00kiemon5ter/3730069b6c920841a3ca
...
for appdir in /opt/homebrew-cask/Caskroom/*; do
  [ -d "${appdir}" ] || continue
  app="${appdir##*/}"
